...
import { Node, UnicodeCharacterLiteral, UnicodeCharacterRange, Prose, Parameter, ParameterList, OneOfList, Terminal, SymbolSet, EmptyAssertion, LookaheadAssertion, NoSymbolHereAssertion, LexicalGoalAssertion, Constraints, ProseAssertion, Argument, ArgumentList, Nonterminal, OneOfSymbol, LexicalSymbol, ButNotSymbol, SymbolSpan, RightHandSide, RightHandSideList, Production, TextContent, TerminalLiteral } from "../nodes";
/** {@docCategory Emit} */
export declare class EcmarkupEmitter extends Emitter {
    ...
    private emitRightHandSideWorker;
