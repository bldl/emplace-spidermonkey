...
<html>
  ...
  <head>
    ...
    <title>Usage | Grammarkdown API Reference </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Usage | Grammarkdown API Reference ">
...
<pre><code>Syntax:                   grammarkdown [options] [...files]
          ...
          <div class="hidden-sm col-md-2" role="complementary">
            <div class="sideaffix">
              <div class="contribution">
                <ul class="nav">
                  <li>
                    <a href="https://github.com/rbuckton/grammarkdown/blob/docs/src/docs/content/overview/cli.md/#L1" class="contribution-link">Improve this Doc</a>
                  </li>
                </ul>
              </div>
